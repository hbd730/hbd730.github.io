...
{Reporting to CPO, responsible for research and development of robot route planning software stack; Web backend and cloud development and deployment.}
  \resumeSubHeadingListStart
    ...
    \item Designed and developed a global path planner with novel approach for non-holonomic constrained robots in broadacre controlled traffic environment.

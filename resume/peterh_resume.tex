...
{Reporting to CPO, responsible for research and development of robot route planning software stack; Web backend and cloud development and deployment.}
  \resumeSubHeadingListStart
    ...
    \item Designedand developed a full coverage planner with heuristic-based optimal decision making - a TSP problem with more chanllenging constraints, e.g. obstacles avoidance. 

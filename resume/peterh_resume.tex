...
\section{Summary}
{
 Over 10 years industrial experience in software and system engineering, algorithm research and development in areas of robotics, automated driving, cloud application development and real time embedded system.
}
...
\resumeItemNoBullet
{Dek Technologies}{Melbourne, Australia}
{Senior Software Engineer}{January 2023 -- Present}

\vspace{10pt}
{Reporting to Aftermarket Seeing Machine Engineering Manager, working with cross-discipline Engineering teams to deliver commercial driver monitoring application for Caterpillar.}
  \resumeSubHeadingListStart
  \item Achieved Milestone 1 customer devliverable through defining epic on smart camera diagnostics topic via FCP (Fovio communication protocol), developing stakeholder, system and software requirement, system architecture, scoping out design tasks for junior engineers and supporting test engineer for system integration test.

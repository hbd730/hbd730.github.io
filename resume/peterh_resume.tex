...
\section{Summary}
{
 Over 10 years industrial experience in software and system engineering, algorithm research and development in areas of robotic, AI, automated driving, cloud application development, and real time embedded system.
}
...
\vspace{10pt}
{Report to Delivery Partner - Head of Google Cloud, responsible for presales and delivery of Google Cloud AI/ML projects.}
  \resumeSubHeadingListStart
  \item Presales and delivery of Generative AI application demo in capital market using Vertex AI and large language model in Google Cloud.
...
{Reporting to Seeing Machine Engineering Manager, working with cross-discipline Engineering teams to deliver commercial driver monitoring integration solution for Caterpillar.}
  \resumeSubHeadingListStart
  \item Architected and implemented health and telemetry data collection, processing, transmission from a in-vehicle Driver Safety System (DSS), and integrated with Gaurdian Live(a cloud-based monitoring platform) via 4G network.
  ...
  \item Led system requirement and system design worshops with internal and external stakeholders.
  \resumeSubHeadingListEnd
...
\section{Professional Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Programming Languages}{: C/C++, Python, F sharp, Bash, HTML, CSS, Javascript, SQL, Objective C, Matlab, VHDL, PLC, Assembly, \LaTeX, LabView}
	}
    \item{

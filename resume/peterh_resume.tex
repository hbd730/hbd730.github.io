...
\vspace{10pt}
{Reporting to CPO, responsible for research and development of mapping and navigation modelues; Support field testing and deployment in SwarmBot4 and release to customers.}
  \resumeSubHeadingListStart
    \item Achieved cetimeter-level precision multi-agent route planning and motion planning for robot with non-holonomic constraints; 
    \item Developed numeric non-linear optimization based path smoothing algorithm and Hybrid A* search algorithm for custom route preferences, motion behaviours and manoeuvre for automatic dock and refill. 
    \item Automation of navigation map data model creation pipeline and model visualization in QGIS.

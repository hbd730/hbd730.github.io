...
\vspace{10pt}
{Reporting to Seeing Machine Engineering Manager, working with cross-discipline Engineering teams to deliver commercial driver monitoring application for Caterpillar.}
  \resumeSubHeadingListStart
  \item Architecting and designing system health module from customer requirement to production software. Lead and collaborate with a small team in VN and AU to deliver software release and provide support to customer.
  \resumeSubHeadingListEnd

...
\section{Summary}
{
 10 years industrial experience in software engineering, algorithm research and development in areas of robotics, automated driving, cloud application development and real time embedded system.
}
...
\vspace{10pt}
{Reporting to CPO, responsible for research and development of robot route planning software stack; Web backend and cloud development and deployment.}
  \resumeSubHeadingListStart
    \item Successfully developed and deployed swarmfarm-planning server backend and scalable navigation model creation pipeline on AWS; Integrated and launched with SwarmFarm GIS data management platform.
    \item Designed and developed a global path planner with novel approach for non-holonomic constrainted robots in broadacre controlled traffic environment.
    \item Designed and developed a full coverage planner with heuristic-based optimal decision making - a TSP problem with more challenging constraints, e.g. obstacles avoidance. 
    \item Developed Hybrid A* with numeric optimization based path smoothing algorithm in free space environment, e.g. turf farm and orchard.

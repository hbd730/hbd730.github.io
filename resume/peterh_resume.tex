...
\section{Summary}
{
 A result-driven software and system engineer with over 10 years experience in software engineering, possess strong competency and industrial experience in areas of robot mapping and localization, path planning, sensor fusion, machine learning and vision. 
}
...
{Reporting to CPO, responsible for research and development of robot route planning software stack; Web backend and cloud development and deployment.}
  \resumeSubHeadingListStart
    \item Successfully developed and deployed swarmfarm-planning server backend and scalable navigation model creation pipeline on AWS; Integrated and launched with SwarmFarm GIS data management platform - Farm Manager \url{http://farmmanager.swarmfarm.com/}.
